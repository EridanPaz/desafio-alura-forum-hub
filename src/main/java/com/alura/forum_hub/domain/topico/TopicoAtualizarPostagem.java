...
@Service
public class TopicoAtualizarPostagem {
  ...
  public TopicoDetalhamento postarAtualizacao(TopicoCadastro dadosTopico){
    ...
    var id    = cursoRepository.getReferenceById(dadosTopico.id());
